...
function module:ExportProfileString()
	if not TavernUI.db or not TavernUI.db.profile then return "" end
...
function module:ApplyPendingImport()
	if not pendingImportData or not TavernUI.db or not TavernUI.db.profile then return end
...
function module:OnInitialize()
	TavernUI:RegisterImportExportOptionsBuilder(function()
		return self:GetProfileImportExportOptions()
	end)
end
